...
/// Every piano-voice test here varies only attack and decay; the rest of the
/// note is held fixed so the envelope is the only difference under test.
...
fn tab_controls_classify_each_slider_kind() {
    ...
    let cases = [
        ...
        (
            Tab::Lead,
            vec![
                Gain, Timing, Timing, Timing, Discrete, Timing, Timing, Discrete, Discrete,
                Discrete, Discrete, Discrete, Discrete, Discrete, Discrete, Discrete, Gain,
            ],
        ),
    ];
