...
- `fluid/` — the core engine module:
  ...
  - `automation.rs` — automation routes keyed by stable control ID. Stores editor/open state and per-control LFO settings for runtime modulation and song-code persistence.
